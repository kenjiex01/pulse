...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasColumn('tbl_company_document_forms', 'requires_nte')) {
            Schema::table('tbl_company_document_forms', function (Blueprint $table) {
                $table->boolean('requires_nte')->default(false);
            });
        }

        CompanyDocumentForm::query()
            ->where('code', 'hr_notice_to_explain')
            ->update(['requires_nte' => true]);
    }
