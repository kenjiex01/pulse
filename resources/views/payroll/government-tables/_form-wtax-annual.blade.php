<form method="POST" action="{{ $isEdit ? route('payroll.government-tables.wtax2023-annual.update', $record->govt_table_wtax_annual_2023_id) : route('payroll.government-tables.wtax2023-annual.store') }}" class="space-y-4">
    ...
    <div>
        ...
        <input id="income_from_{{ $formContext }}" name="income_from" type="number" step="0.01" min="0" value="{{ old('income_from', $record?->income_from) }}" class="form-input" required>
    ...
    <div>
        ...
        <input id="income_to_{{ $formContext }}" name="income_to" type="number" step="0.01" min="0" value="{{ old('income_to', $record?->income_to) }}" class="form-input" required>
    ...
    <div>
        ...
        <input id="amount_due_{{ $formContext }}" name="amount_due" type="number" step="0.01" min="0" value="{{ old('amount_due', $record?->amount_due) }}" class="form-input" required>
    ...
    <div>
        ...
        <input id="percentage_due_{{ $formContext }}" name="percentage_due" type="number" step="0.01" min="0" value="{{ old('percentage_due', $record?->percentage_due) }}" class="form-input" required>
