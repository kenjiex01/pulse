...
@section('content')
    ...
    @include('partials.page-header', [
        ...
        'description' => 'Pamahalaan ang mga user account',
        'actionUrl' => route('users.create'),
        'actionLabel' => '+ Bagong User',
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center justify-end gap-1.5">
                                <a href="{{ route('users.show', $user) }}" class="btn-icon" title="Tingnan">
                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                </a>
                                <a href="{{ route('users.edit', $user) }}" class="btn-icon" title="I-edit">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="py-12 text-center">
                            ...
                            <p class="text-sm font-medium text-gray-500">Walang users</p>
                            <p class="mt-1 text-xs text-gray-400">Mag-click ng "+ Bagong User" para magsimula.</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
