...
class NdRateGroupDayType extends Model
{
    use SoftDeletes;

    public $timestamps = false;

    protected $table = 'tbl_nd_rate_group_day_types';

    protected $primaryKey = 'nd_rate_group_day_type_id';
