...
return [
    'campuses' => [
        ...
        'columns' => [
            ...
            ['key' => 'parentCampus.campus_name', 'label' => 'Under'],
        ...
        'fields' => [
            ...
            [
                'name' => 'parent_campus_id',
                'label' => 'Under Campus',
                'type' => 'select',
                'source' => 'campuses',
                'placeholder' => 'None (standalone campus)',
                'exclude_self' => true,
                'rules' => ['nullable', 'integer', 'exists:tbl_campuses,campus_id'],
            ],
            ['name' => 'minimum_wage', 'label' => 'Minimum Wage', 'type' => 'number', 'step' => '0.01', 'rules' => ['nullable', 'numeric', 'min:0']],
